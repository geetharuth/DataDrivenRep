...
{
	ExcelFileUtil xl=new ExcelFileUtil("C:\\eclipse/sample.xlsx");
	...
	//	xl.setcellData("emp", i, 4, "pass", "C:\eclipse/sampleresults3.xlsx");
		xl.setcellData("emp", i, 4, "failss", "C:\\eclipse/sampleresults3.xlsx");
		//xl.setcellData("emp", i, 4, "Blocked", "C:\eclipse/sampleresults3.xlsx");
	}
}
